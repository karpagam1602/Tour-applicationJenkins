...
public class BookingDaoImpl implements BookingDao {
	...
	public boolean updatemailBooking(int bookingId) {
		...
		message.setText(
				"Dear " + userName + "\r\nThis is from Alpha Tourism." + "\r\nYour booking package " + packagename
						+ " is approved." + "\r\n please pay your amount Rupees " + cost + " for the booking package"
	...
	public boolean updateEmailRejected(int bookingId) {
		...
		message.setText("Dear " + userName + "\r\nThis is from Alpha Tourism." + "\r\nYour booking package "
				+ packagename + " is Rejected because of the following one reason"
				+ "\r\n * Because of Natural Calameties" + "\r\n * Application overloaded"
